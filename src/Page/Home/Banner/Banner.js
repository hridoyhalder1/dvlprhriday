            ...
            <div className="hero min-h-screen bg-slate-900">
                <div className="hero-content flex-col lg:flex-row lg:gap-12">
                    ...
                    <div>
                        ...
                        <p className=' text-white'>My name is Hriday Haldar. I am a front-end web developer, React Developer and MERN stack developer. I love to explore new technologies, solve new problems and continuously  learn new things to make the websites. </p>
